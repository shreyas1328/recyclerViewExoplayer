...
public class VideoPlayerRecyclerView extends RecyclerView {
    ...
    // vars
    private ArrayList<MediaData> mediaObjects = new ArrayList<>();
    ...
    private void init(Context context) {
        ...
        addOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrollStateChanged(RecyclerView recyclerView, int newState) {
                ...
                Log.d("state_check", "onScrollStateChanged: " + newState);
            ...
            public void onPlayerStateChanged(boolean playWhenReady, int playbackState) {
                switch (playbackState) {
                    ...
                    case Player.STATE_BUFFERING:
                        Log.d("player_tstae", "onPlayerStateChanged: Buffering video.");
                        if (progressBar != null) {
                    ...
                    case Player.STATE_ENDED:
                        Log.d("player_tstae", "onPlayerStateChanged: Video ended.");
                        videoPlayer.seekTo(0);
                        break;
                    case Player.STATE_IDLE:
                        Log.d("player_tstae", "onPlayerStateChanged: Ready to idle.");
                        break;
                    case Player.STATE_READY:
                        Log.d("player_tstae", "onPlayerStateChanged: Ready to play.");
                        if (progressBar != null) {
    ...
    public void playVideo(boolean isEndOfList) {
        ...
        Log.d("test_video_123", "playVideo: " + isEndOfList);
        int targetPosition;
        ...
        if (true) {
            ...
            Log.d("video_pos_qw", "playVideo: " + startPosition + "     " + endPosition);
...
//        }
        ...
        Log.d("targetVideoPos", "playVideo: target position: " + targetPosition);
...
//        scrollToPosition(targetPosition);
        Log.d("test_pos_444", "playVideo: " + currentPosition + "     " + targetPosition);
        View child = getChildAt(currentPosition);
        Log.d("child_test", "child: " + (child == null));
        if (child == null) {
            return;
        }
    ...
    public void setMediaObjects(ArrayList<MediaData> mediaObjects) {
